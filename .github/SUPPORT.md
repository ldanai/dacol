# Getting help with dacol

Thanks for using dacol. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/dacol/issues) to make sure the 
